# -*- coding: utf-8 -*-
#
# django-pgstats documentation build configuration file, created by
...
htmlhelp_basename = 'django-pgstatsdoc'
...
latex_documents = [
    (
        master_doc,
        'django-pgstats.tex',
        u'django-pgstats Documentation',
        u'Opus 10',
        'manual',
    )
]
